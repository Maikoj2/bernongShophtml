    ...
    return {
        ...
        initFlotGraph: function() {
            ...
            if($("#graph-earnings").length) {
                ...
                var data = [
                    {
                        data: [["manizales", 600000]], color: bgWarning
                    }, 
                    {
                        data: [["Sincelejo", 470121]], color: bgDanger
                    },
                    {
                        data: [["Medellin", 890000]], color: bgInfo
                    },
                    {
                        data: [["Bogota", 780000]], color: bgPrimary
                    },
                    {
                        data: [["Barranquilla", 1000000]], color: bgSuccess
                    },
                    {
                        data: [["Santa marta", 540000]], color: bgSunFlower
                    }
                ];
                ...
                $.plot("#graph-earnings", data, {
                    ...
                    colors: [Colors[0]],
                    yaxis: {
                        axisLabel: "ganancias por ciudades",
                        axisLabelUseCanvas: true,
                        axisLabelFontSizePixels: 12,
                        axisLabelFontFamily: 'Verdana, Arial',
                        axisLabelPadding: 3,
